...
if __name__ == '__main__':
    ...
    rostest.unitrun('./', 'FK-report_WZ', 'test_FK.FK.test_world_to_zero', sysargs=None)
    rostest.unitrun('./', 'FK-report_ZO', 'test_FK.FK.test_zero_to_one', sysargs=None)
    rostest.unitrun('./', 'FK-report_OE', 'test_FK.FK.test_one_to_end_effector', sysargs=None)
    rostest.unitrun('./', 'FK-report_FK', 'test_FK.FK.test_ForKin', sysargs=None)
    rostest.rosrun('./', 'FK-report_FULL', 'test_FK', sysargs=None)
